...
webpackJsonpL2Dwidget([0], {
  79: function (t, e, i) {
    ...
    function L(t) {
      ...
      var e = n.currCanvas.getBoundingClientRect(),
        ...
        r = D(t.clientY - e.top),
        o = v(
          { x: e.left + e.width / 2, y: e.top + e.height * P },
    ...
    function A(t) {
      ...
      "touchstart" == t.type
        ...
        ? ((e = h),
          ...
          (o = D(e.clientY - i.top)),
          (s = v(
            { x: i.left + i.width / 2, y: i.top + i.height * P },
    ...
    (e.theRealInit = function (t) {
      ...
      var e,
        i,
        r = n.currCanvas.getBoundingClientRect(),
        $ = r.height / r.width,
  ...
  80: function (t, e, i) {
    ...
    (function (t) {
      ...
      function $() {
        i ||
          ((this._$vo = null), (this._$F2 = null), (this._$ao = 400), (this._$1S = 400), $._$42++);
      }
      function u() {
        i ||
          ((this.p1 = new p()),
            ...
            if (1 == t.length) {
              ...
              for (u = 0; u < t.length; u++) {
                ...
                if (o == u) s.setPartsOpacity(c, n);
                  ...
                  var l,
                    $ = s.getPartsOpacity(c);
                  (1 - (l = n < 0.5 ? (-0.5 * n) / 0.5 + 1 : (0.5 * (1 - n)) / 0.5)) * (1 - n) >
                    0.15 && (l = 1 - 0.15 / (1 - n)),
                    $ > l && ($ = l),
                    s.setPartsOpacity(c, $);
                }
        ...
        (s.prototype.updateParam = function (t, e) {
          if (e._$AT && !e._$9L) {
            ...
            (0 <=
              (o =
                o *
                (0 == this._$dP ? 1 : at._$r2((i - e._$bs) / this._$dP)) *
                (0 == this._$eo || e._$Do < 0 ? 1 : at._$r2((e._$Do - i) / this._$eo))) &&
              o <= 1) ||
              console.log("### assert!! ### "),
      ...
      (T._$ni = function (t, e, i, r, o, n, s, _, a) {
        ...
        (S._$Z2 = function (t, e, i, r) {
          ...
          if (4 == o) {
            ...
            return (
              ((S =
                ((_ = ((p = (v + (L - v) * $) | 0) + ((c = (M + (E - M) * $) | 0) - p) * u) | 0) +
                  ((a = ((f = (A + (x - A) * $) | 0) + ((g = (I + (w - I) * $) | 0) - f) * u) | 0) -
                    _) *
                    P) |
                0) +
                ((((h = ((y = (D + (O - D) * $) | 0) + ((d = (R + (b - R) * $) | 0) - y) * u) | 0) +
                  ((l = ((m = (F + (C - F) * $) | 0) + ((T = (N + (B - N) * $) | 0) - m) * u) | 0) -
                    h) *
                    P) |
                  0) -
                  S) *
        ...
        (S._$Vr = function (t, e, i, r, o, n, s, _) {
          ...
          if (a <= 0) {
            ...
            else for (var c = 0; c < $; ) (n[u] = p[c++]), (n[u + 1] = p[c++]), (u += _);
          } else if (1 == a) {
            p = o[h[0]];
            var f = o[h[1]],
              g = 1 - (m = l[0]);
      ...
      (V.STATE_FIRST = "STATE_FIRST"),
        ...
        (z.prototype._$2b = function (t, e) {
          ...
          if ((i._$hS(!0), this._$32())) {
            ...
            if ((i._$8r == A._$ur && (i._$8r = t.getBaseDataIndex(r)), i._$8r < 0))
              _t._$so && _._$li("_$L _$0P _$G :: %s", r), i._$hS(!1);
            else {
        ...
        (z.prototype._$nb = function (t, e, i, r, o, n, s) {
          ...
          for (
            ...
            (_ = i[v]), (a = i[v + 1]), (r[v] = g * _ + y * a + T), (r[v + 1] = d * _ + m * a + P);
        }),
                  ...
                  if ((97 <= s && s <= 122) || (65 <= s && s <= 90) || "_" == n) {
                    ...
                    if (u >= 0) {
                      ...
                      w.startsWith(t, $, J._$cs)
                        ? ((_._$RP = N._$hs), (_._$4P = w.createString(t, $, u - $)))
                        : w.startsWith(t, $, J._$ar)
                        ? ((_._$4P = w.createString(t, $ + 7, u - $ - 7)),
                          w.startsWith(t, $ + 7, "ANCHOR_X")
                            ...
                            : w.startsWith(t, $ + 7, "X")
                            ? (_._$RP = N._$ws)
                            : w.startsWith(t, $ + 7, "Y") && (_._$RP = N._$Ns))
                        : ((_._$RP = N._$Fr), (_._$4P = w.createString(t, $, u - $))),
                        e.motions.push(_);
                      var a = 0,
                        h = [];
                      for (o = u + 1; o < r && "\r" != (n = Q(t, o)) && "\n" != n; ++o)
          ...
          for (
            ...
            if (a._$RP == N._$hs) {
              ...
              var u = t.getParamIndex(l),
                ...
                d =
                  f +
                  (((g < y && y - g > c) || (g > y && g - y > c) ? g : g + (y - g) * s) - f) * i;
              t.setParamFloat(l, d);
            }
          }
          n >= this._$yT &&
          ...
          for (
            ...
            if (
              ...
              if (!m) {
                ...
                (p -= 0.5 * ((f = 0.5 * (E + x)) + (y = 0.5 * (E - x)))),
                  (c -= 0.5 * ((g = 0.5 * (A + I)) + (d = 0.5 * (A - I))));
              }
              if (-2 < v && v < 3 && -2 < L && L < 3)
                if (v <= 0)
                  if (L <= 0) {
              ...
              (h = 2 * ((0 | P) + (0 | S) * (_ + 1))),
                (l = P - (0 | P)) + ($ = S - (0 | S)) < 1
                  ? ((i[T] = s[h] * (1 - l - $) + s[h + 2] * l + s[h + 2 * (_ + 1)] * $),
                    (i[T + 1] = s[h + 1] * (1 - l - $) + s[h + 3] * l + s[h + 2 * (_ + 1) + 1] * $))
                  : ((i[T] =
                      s[h + 2 * (_ + 1) + 2] * (l - 1 + $) +
                      s[h + 2 * (_ + 1)] * (1 - l) +
                      s[h + 2] * (1 - $)),
          ...
          for (
            ...
            _t._$ts
              ...
              : ((u = (_ = i[m] * f) - (0 | _)),
                ...
                ($ = 2 * ((0 | _) + (0 | a) * (f + 1)))),
              u + p < 1
                ? ((r[m] = d[$] * (1 - u - p) + d[$ + 2] * u + d[$ + 2 * (f + 1)] * p),
                  (r[m + 1] = d[$ + 1] * (1 - u - p) + d[$ + 3] * u + d[$ + 2 * (f + 1) + 1] * p))
                : ((r[m] =
                    d[$ + 2 * (f + 1) + 2] * (u - 1 + p) +
                    d[$ + 2 * (f + 1)] * (1 - u) +
                    d[$ + 2] * (1 - p)),
            ...
            for (
              ...
              if ((n || (n = 1.2), _t.IGNORE_EXPAND && (n = 0), _t.USE_CACHED_POLYGON_IMAGE)) {
                ...
                _t.IGNORE_CLIP || ot.clip(u, y, n, k, O, R, b, F, C, N, E, A, x, I, w, D),
                  _t.USE_ADJUST_TRANSLATION && ((W = 0), (j = l), (q = 0), (J = $)),
        ...
        (ot.expandClip = function (t, e, i, r, o, n, s, _, a, h) {
          ...
          return (
            null != e._$P2(N) &&
            (ot.clipWithTransform(t, N, M, E, A, x, I, w, D, O, F, C, R, b), !0)
          );
        }),
        ...
        (ot.createCanvas = function (t, e) {
          ...
          return (
            i.setAttribute("width", t), i.setAttribute("height", e), i || _._$li("err : " + i), i
          );
        }),
        ...
        (dt.prototype.createFramebuffer = function () {
          ...
          return (
            ...
            { framebuffer: i, renderbuffer: r, texture: _t.fTexture[this.glno] }
          );
        }),
        ...
        (Mt.setup = function () {
          ...
          if ((t = e.indexOf("iPhone OS ")) >= 0)
            ...
            (t = e.indexOf("Android")) >= 0
              ? ((r.os = "Android"), (r._isAndroid = !0), (r.version = i(e, t + "Android ".length)))
              : ((r.os = "-"), (r.version = -1));
        }),
        _t.init();
      i = !1;
